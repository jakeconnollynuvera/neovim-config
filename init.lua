...
-- Set Half page up and down to also center cursor
vim.keymap.set('n', '<C-d>', '<C-d>zz')
vim.keymap.set('n', '<C-u>', '<C-u>zz')

-- Set space p to delete to underscore register and P paste to maintain what is in register
...
do
  ...
  vim.keymap.set('n','<leader>j', '<cmd>Grapple toggle_tags<cr>',{ desc = 'Toggle tags menu' })
end
